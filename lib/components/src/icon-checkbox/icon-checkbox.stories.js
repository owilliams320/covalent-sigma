...
export const Template = ({ width, height, iconOnly }) => {
  return `
    <div style="width:600px; display:flex; border:solid 1px var(--mdc-theme-border); padding: 16px 0px; justify-content: center; gap:16px;">
      <td-checkbox-icon width="${width}" height="${height}"${iconOnly ? " iconOnly" : ""}>
  ...
  return `
    <div class="mdc-layout-grid">
      <div class="mdc-layout-grid__inner">
        <td-checkbox-icon width="${width}" height="${height}" ${iconOnly ? "iconOnly" : ""} class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4">
