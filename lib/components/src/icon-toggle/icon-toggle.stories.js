...
export const Template = ({ width, height, iconOnly }) => {
  return `
    <div style="width:600px; display:flex; border:solid 1px var(--mdc-theme-border); padding: 16px 0px; justify-content: center; gap:16px;">
      <td-icon-check-item width="${width}" height="${height}"${iconOnly ? " iconOnly" : ""}>
...
export const IconCheckToggle = ({ width, height, iconOnly }) => {
  return `
    <td-icon-check-item width="${width}" height="${height}" ${iconOnly ? "iconOnly" : ""}>
      <td-icon slot="icon">work</td-icon>
      <div slot="text">Balanced</div>
...
export const IconRadioToggle = ({ width, height, iconOnly }) => {
  return `
    <td-icon-radio-item width="${width}" height="${height}" ${iconOnly ? "iconOnly" : ""}>
      <td-icon slot="icon">work</td-icon>
      <div slot="text">Balanced</div>
      <div slot="text">Every week</div>
    </td-icon-radio-item>
  ...
  return `
    <div class="mdc-layout-grid">
      <div class="mdc-layout-grid__inner">
        <td-icon-check-item width="${width}" height="${height}" ${iconOnly ? "iconOnly" : ""} class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4">
