 ...
 import {MDCChipActionType, MDCChipActionFocusBehavior, MDCChipActionInteractionTrigger} from '@material/chips/action/constants';
 import {MDCChipActionInteractionEventDetail} from '@material/chips/action/types';
 
 import {MDCChipAdapter} from '@material/chips/chip/adapter';
 import {MDCChipAnimation, MDCChipAttributes, MDCChipCssClasses, MDCChipEvents} from '@material/chips/chip/constants';
 import {ActionInteractionEvent, ActionNavigationEvent, MDCChipAnimationEventDetail, MDCChipInteractionEventDetail, MDCChipNavigationEventDetail} from '@material/chips/chip/types';
 ...
 export class MDCChipFoundation extends MDCFoundation<MDCChipAdapter> {
   ...
   handleAnimationEnd(event: AnimationEvent) {
     ...
     if (animationName === MDCChipAnimation.ENTER) {
       ...
       this.adapter.emitEvent<MDCChipAnimationEventDetail>(MDCChipEvents.ANIMATION, {
   ...
   handleActionInteraction({detail}: ActionInteractionEvent) {
     ...
     this.adapter.emitEvent<MDCChipInteractionEventDetail>(MDCChipEvents.INTERACTION, {
       chipID: this.getElementID(),
   ...
   handleActionNavigation({detail}: ActionNavigationEvent) {
     ...
     this.adapter.emitEvent<MDCChipNavigationEventDetail>(MDCChipEvents.NAVIGATION, {
       chipID: this.getElementID(),
       isRTL,
       source,
       key,
