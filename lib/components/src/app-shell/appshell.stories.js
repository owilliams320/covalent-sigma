...
import '../action-ribbon/action-ribbon.component';
import '../list/td-list-expansion.component';
import '../list/td-list-item.component';
...
const Template = ({ navClick }) => {
    ...
    td-app-shell [slot="navigation"] mwc-list-item,
    td-app-shell [slot="navigation"] td-list-item,
    td-app-shell [slot="user-menu"] mwc-list-item:not(.beta-list-item) {
        border-radius: 0 28px 28px 0;
        margin-right: 16px;
    }

    td-app-shell:not([open]) [slot="navigation"] mwc-list-item,
    td-app-shell:not([open]) [slot="navigation"] td-list-item,
    td-app-shell:not([open]) [slot="user-menu"] mwc-list-item:not(.beta-list-item) {
        border-radius: 100%;
        margin: 0 auto 8px;
        padding: 0;
        width: 48px;
    ...
    td-app-shell:not([open]) mwc-list-item [slot="graphic"],
    td-app-shell:not([open]) td-list-item mwc-icon {
        margin-left: 8px
    }

    td-app-shell:not([open]) td-expansion-list {
        --td-list-item-text-icon-on-background: transparent;
        --td-list-menu-height: 0;  
    }

    td-app-shell:not([open]) .beta-list-item {
    ...
    td-app-shell [slot="navigation"] mwc-list-item[graphic=avatar] mwc-icon[slot=graphic],
    td-app-shell [slot="user-menu"] mwc-list-item[graphic=avatar]:not(.beta-list-item) mwc-icon[slot=graphic] {
    ...
    td-app-shell:not([open]) .home-item {
        background-color: #f3753f;
        --mdc-ripple-color: #fff;
        --mdc-theme-text-icon-on-background: #fff;
    } 

    .home-item .covalent-icon:not(.teradata-circle) {
        --mdc-list-item-graphic-size: 40px;
        --mdc-icon-size: 40px;
    }

    .home-item .home-icon {display: none;}
    .home-item .teradata-circle {display: none;}
    .home-item .teradata-no-circle {display: block;}
    .home-item:hover .home-icon {display: block;}
    .home-item:hover .covalent-icon {display: none;}
    td-app-shell[open] .home-item .covalent-icon {display: none;}
    td-app-shell[open] .home-item .covalent-icon.teradata-circle {display: block;}
    td-app-shell[open] .home-item:hover .covalent-icon.teradata-circle {display: none;}
    </style>
    ...
    <mwc-list slot="navigation" activatable>
        <mwc-list-item class="home-item" graphic="avatar" >
            <span>Vantage</span>
            <mwc-icon class="covalent-icon teradata-circle" slot="graphic">teradata</mwc-icon>
            <mwc-icon class="covalent-icon teradata-no-circle" slot="graphic">teradata_nocircle</mwc-icon>
        ...
        <td-expansion-list activatable>
            <td-list-item slot="expansionHeader" graphic="avatar" hasChildren>
               Editor
               <mwc-icon class="covalent-icon" slot="graphic">product_editor</mwc-icon>
            </td-list-item>
