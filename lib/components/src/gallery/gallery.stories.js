...
const Template = ({}) => {
    return `
        ...
        <td-gallery>
            ...
            <!-- Will replace this when toolbar component is merged --!>
            ...
            <div class="container">
                <td-card outlined ripple sourceType="project" sourceCreator="Josh Williams" cardTitle="Cellular Wifi Network Performance">
                    <div slot="card-content">Data collected from device related to cellular network telemetry.</div>
                </td-card>
                <td-card outlined ripple sourceType="dataset" sourceCreator="Josh Williams" cardTitle="Cellular Device Location">
                    <div slot="card-content">
                        Data collected from the device related to location detected by the global positioning system.
                    </div>
                </td-card>
                <td-card outlined ripple sourceType="dataset" sourceCreator="Josh Williams" cardTitle="Device Network Traffic">
                    <div slot="card-content">
                        Data collected from the device related to network traffic as collected from Android TrafficStats API.
                    </div>
                </td-card>

                <td-card outlined ripple sourceType="project" sourceCreator="Josh Williams" cardTitle="FWA Analysis">
                    <div slot="card-content">
                ...
                <td-card outlined ripple sourceType="dataset" sourceCreator="Josh Williams" cardTitle="Device Wifi Connect">
                    <div slot="card-content">
                    Data collected from the device related to network traffic as collected from Android TrafficStats API.
                    </div>
                </td-card>
                <td-card outlined ripple sourceType="dataset" sourceCreator="Josh Williams" cardTitle="Cellular Network Telemetry">
                    <div slot="card-content">
                        Data collected from device related to cellular network telemetry.
                    </div>
                </td-card>

                <td-card outlined ripple sourceType="article" sourceCreator="Josh Williams" cardTitle="FWA Forecasting">
                    <div slot="card-content">Hello</div>
                </td-card>
                <td-card outlined ripple sourceType="dataset" sourceCreator="Josh Williams" cardTitle="Pharmacy Data">
                    <div slot="card-content">Hello</div>
                </td-card>
                <td-card outlined ripple sourceType="file" sourceCreator="Josh Williams" cardTitle="Cellular Wifi Network Performance">
                    <div slot="card-content">Hello</div>
                </td-card>          
            </div>
        </td-gallery>
