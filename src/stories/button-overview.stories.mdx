...
<style>{`
  ...
  #story--example-button--contained,
  #story--example-button--text {
    margin-right: 8px;
  }
  mwc-button[raised].destructive {
...
<form>
  ...
  <mwc-button outlined label="Button"></mwc-button>
  <mwc-button raised label="Primary"></mwc-button>
</form>
</Canvas>
...
<form>
  <mwc-button outlined label="Button"></mwc-button>
  <mwc-button outlined label="Button"></mwc-button>
  <mwc-button raised label="Delete" class="destructive"></mwc-button>
</form>
</Canvas>
