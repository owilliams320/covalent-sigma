...
<Canvas>
  <Story id="example-button--text" />
  <Story id="example-button--outlined" />
  <Story id="example-button--contained" />
</Canvas>
...
<form>
  <mwc-button outlined label="Button"></mwc-button>
  <mwc-button outlined label="Button"></mwc-button>
  <mwc-button raised label="Button" class="primary accent"></mwc-button>
</form>
</Canvas>
