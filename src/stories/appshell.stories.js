...
const Template = ({ type, navClick }) => {
  ...
  return `
    ...
    <mwc-drawer type="${type}" style="position:absolute;">
     ...
     padding-right: var(--mdc-list-side-padding, 16px);">
       ...
       <svg class="logo-wordmark" style="width:100px; margin-left:8px;" viewBox="0 0 696 133" fit=""  preserveAspectRatio="xMidYMid meet" focusable="false">
      ...
      <mwc-list  activatable>
       ...
       <mwc-list  activatable>
        ...
        <div slot="appContent">
            ${topAppBarComponent({ title: 'Your Vantage'}, { parameters:{ fixed:true} })}
        </div>
    </mwc-drawer>`;
};
