...
import '../lib/components/app-shell/app-shell.component';
import '../lib/components/action-ribbon/action-ribbon.component';
import '../lib/components/list/td-list-expansion.component';
import '../lib/components/list/td-list-item.component';
...
const Template = ({ navClick }) => {
    ...
    .home-item .teradata-icon {display: none;}
    ...
    td-app-shell[open] .home-item .teradata-icon {display: block;}
    td-app-shell[open] .home-item:hover .teradata-icon {display: none;}
    ...
    <mwc-list slot="navigation"  activatable>
        <mwc-list-item class="home-item" graphic="avatar" >
            ...
            <mwc-icon class="covalent-icon" slot="graphic">teradata_nocircle</mwc-icon>
